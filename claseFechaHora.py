...
class FechaHora:
    ...
    def Verificar(self):
        ...
        while self.__mes>12:                #SI EL MES ES MAYOR A 12 SE LE RESTA 12 
            self.__mes=self.__mes-12        #Y SI DESPUES DE LA RESTA SIGUE SIENDO MAYOR VUELVE A ITERAR
    ...
    def __add__(self, otraFecha):
        if type(otraFecha)==FechaHora:
            return FechaHora(self.__dia+otraFecha.__dia,self.__mes+otraFecha.__mes,self.__año+otraFecha.__año,self.__hora+otraFecha.__hora,self.__minutos+otraFecha.__minutos,self.__segundos+otraFecha.__segundos)

    def __sub__(self,otraFecha):
        if type(otraFecha)==FechaHora:
            return abs(self.aSegundos()-otraFecha.aSegundos())
    ...
    def __gt__(self,otraFecha):
        ...
        if type(otraFecha)==FechaHora:
            if self.aSegundos()>otraFecha.aSegundos():
             band=1
            elif self.aSegundos()==otraFecha.aSegundos() :
                band=0
            elif self.aSegundos()<otraFecha.aSegundos():
                band=2
        else:
